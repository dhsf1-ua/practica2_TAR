...
class MovimientoRobot(Node):
    ...
    def wait_for_odom(self):
        # Espera hasta recibir el primer mensaje de odometria.
    ...
    def move_linear(self, distance, speed=0.2):
        # Usar la odometria para moverse la distancia pedida
        self.wait_for_odom()
        rclpy.spin_once(self, timeout_sec=0.1)
    ...
    def mov_3_infinito(self):
        ...
        self.rotate(math.radians(-120))  # -120 (hacia la derecha)
